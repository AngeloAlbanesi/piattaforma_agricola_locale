...
import { PublicAziendaDetailDTO, PublicProdottoSummaryDTO, getProdottoId } from '../../../../core/models/public.models';
...
export class AziendaDetailComponent implements OnInit, OnDestroy {
     ...
     */
    viewProdotto(prodotto: PublicProdottoSummaryDTO): void {
        const id = getProdottoId(prodotto);
        this.viewProdottoDetail(id);
    }

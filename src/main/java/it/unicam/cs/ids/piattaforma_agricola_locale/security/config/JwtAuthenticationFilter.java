...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(
        ...
        // Se l'header non esiste o non inizia con "Bearer ", passa al filtro
        // successivo.
        ...
        // Se l'email è stata estratta e non c'è già un'autenticazione nel contesto di
        // sicurezza
        if (userEmail != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            try {
                ...
                log.debug("Token ignorato per utente non trovato: {}", userEmail);
                filterChain.doFilter(request, response);
                return;
            }

            // Se il token è valido, crea un token di autenticazione e lo imposta nel
            // contesto
